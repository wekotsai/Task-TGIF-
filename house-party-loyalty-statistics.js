...
//    from the lowest
    members.sort((a, b) => a.total_votes - b.total_votes);
//    console.log(members.map(a => a.missed_votes))
...
//    console.log(leastMissedVotes.length)  
    ...
    //from the highest
    members.sort((a, b) => b.total_votes - a.total_votes);
//    console.log(members.map(a => a.missed_votes))
...
function createLeftTable(myArray, tbodyName){
    ...
    myArray.forEach(oneGuy => {
        ...
        var newTr = document.createElement("tr");
            ...
            newTr.insertCell().innerHTML = oneGuy.total_votes;
            newTr.insertCell().innerHTML = oneGuy.votes_with_party_pct;
